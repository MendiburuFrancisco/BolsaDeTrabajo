...
const iconVerified = <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
...
return <svg xmlns="http://www.w3.org/2000/svg" fill={ filled ===true ? "black" : "none"} viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
{/* <svg xmlns="http://www.w3.org/2000/svg" fill={ filled == true ? "fill" : "none"} viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"> */}
